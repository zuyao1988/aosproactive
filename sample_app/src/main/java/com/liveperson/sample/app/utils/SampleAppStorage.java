...
public class SampleAppStorage {
    ...
    public static final String SDK_SAMPLE_FCM_APP_ID = "com.zulp.sampleapp.com.hsbc.app.name.test.app.push.notifications.hohoh.idontwantofail.abcdefghi.wantotryforandroid.androidshouldbe.can.suppo";
	...
	public String getConsumerId() {
		return mDefaultSharedPreferences.getString(CONSUMER_ID, "auth0|61e75a24e5754c0069a3bde9");
	}
